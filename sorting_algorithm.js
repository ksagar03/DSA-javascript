...
document.write(
  `a.sort(valuecomapre) gives us correct input [${a.sort(valuecompare)}] <br/>`
);
...
arr2 = [3, 1, 2, 4, 5, 6];
document.write(
  `sorted array using optimized [${arr2}] is ${bubbleSortopt(arr2)} <br/>`
);
...
arr = [20, 3, 26, 1, 4];
document.write(
  `sorted array of [${arr}] is [${insertion_sort(
    arr
